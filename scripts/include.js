...
/* ==========================================================================
    ucenter
   ========================================================================== */
jQuery(".ucenter").slide({
	mainCell: ".bd>ul",
	titCell: ".hd .uMenu",
	trigger: "click"
});
jQuery(".buyInUcenter").slide({
	mainCell:".bd>ul",
	trigger:"click"
})
jQuery(".buyOutUcenter").slide({
	mainCell:".bd>ul",
	trigger:"click"
})
jQuery(".msgUcenter").slide({
	mainCell:".bd>ul",
	trigger:"click"
})
/* ==========================================================================
...
/* ==========================================================================
   ...
   ========================================================================== */
// 农产品价格分类标签
jQuery(".tabPriceTag").slide({
	trigger: "click"
});
// 农特产直通车
jQuery(".native_pro").slide({
	titCell: ".hd ul",
	mainCell: ".bd ul",
	autoPage: true,
	effect: "left",
